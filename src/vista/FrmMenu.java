...
public class FrmMenu extends JFrame {
	...
	public FrmMenu() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(FrmMenu.class.getResource("/img/logo02.png")));
		/*
		 * +++++++++++++++++++++++++++++++++++++++
		 * El nombre se trae de FrmLogin > Usuario
		 * +++++++++++++++++++++++++++++++++++++++
		 * */
		setTitle("Bienvenido: " + FrmLogin.usuario.getNombre() + " " + FrmLogin.usuario.getApellido()); // No funciona como deberia funcionar!!!!!
		...
		mntmGestionarVentas.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				/*
				 * +++++++++++++++++++++++++++++++++++++++++++++
				 ...
				 * +++++++++++++++++++++++++++++++++++++++++++++
				 * */
				FrmGestionarVentas frmgv = new FrmGestionarVentas();
				 ...
				 * ++++++++++++++++++++++++++++++++++++++
				 * */
				frmgv.setLocation((escritorio.getWidth() - frmgv.getWidth()) / 2, (escritorio.getHeight() - frmgv.getHeight()) / 2 );
			}
		});
		mntmGestionarVentas.setIcon(new ImageIcon(FrmMenu.class.getResource("/img/gestionarventas.png")));
		mntmGestionarVentas.setPreferredSize(new Dimension(150, 40));
		mnFacturar.add(mntmGestionarVentas);
		...
		mntmReporteVentas = new JMenuItem("Reportes Ventas");
		mntmReporteVentas.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				/*
				 * +++++++++++++++++++++++++++++++++++++++++++++
				 * Llamar_ventana JInternalFrame_ReporteVentas
				 * +++++++++++++++++++++++++++++++++++++++++++++
				 * */
				FrmGenerarReporteVentas frmrv = new FrmGenerarReporteVentas();
				 ...
				 * ++++++++++++++++++++++++++++++++++++++
				 * */
				frmrv.setLocation((escritorio.getWidth() - frmrv.getWidth()) / 2, (escritorio.getHeight() - frmrv.getHeight()) / 2 );
			}
		});
		mntmReporteVentas.setIcon(new ImageIcon(FrmMenu.class.getResource("/img/reporteventas.png")));
		mntmReporteVentas.setPreferredSize(new Dimension(150, 40));
