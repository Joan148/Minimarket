...
public class DlgBannerInicio extends JDialog {
	...
	public DlgBannerInicio() {
		setTitle("Bienvenido");
		setIconImage(Toolkit.getDefaultToolkit().getImage(DlgBannerInicio.class.getResource("/img/logo02min.png")));
		...
		lblJoanKun = new JLabel("Joan Kun");
		lblJoanKun.setForeground(Color.DARK_GRAY);
		lblJoanKun.setFont(new Font("Constantia", Font.BOLD, 46));
		lblJoanKun.setBounds(562, 146, 242, 57);
		contentPanel.add(lblJoanKun);
